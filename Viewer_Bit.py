...
class ViewerBit:
    ...
    def drawBit(self):
        ...
        bit_border = pygame.draw.rect(self.display, self.border_color, (self.x, self.y, 50, 50), 5)
        if self.bit_selected:
            bit_selection = pygame.draw.rect(self.display, (255, 255, 0), (self.x, self.y, 50, 50), 2)
